    ...
    <header className="border-b border-border bg-card">
      <div className="max-w-4xl mx-auto p-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Tooltip content={isKanbanView ? "Switch to List View" : "Switch to Kanban View"} position="bottom">
            <Link href={isKanbanView ? "/list" : "/kanban"}>
              <button className="p-2 rounded-full bg-secondary text-secondary-foreground transition-colors border border-secondary hover:border-primary">
                {isKanbanView ? (
