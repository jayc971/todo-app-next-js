  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 flex-1">
        ...
        {isEditing ? (
          <input
            ...
            className="flex-1 px-3 py-2 border border-input rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
            autoFocus
            onKeyDown={(e) => {
      ...
      <div className="flex">
        {isEditing ? (
          <button
            className="p-2 text-gray-400 border border-border transition-colors rounded-r-md duration-200 ease-in-out hover:text-white hover:bg-green-400 disabled:opacity-50 disabled:pointer-events-none"
            onClick={handleSave}
            aria-label="Save task"
          >
            <Check className="h-100 w-4" />
          </button>
        ) : (
          <div className="flex border border-border rounded-md overflow-hidden">
            <button
              className="p-2 text-gray-400 transition-colors duration-200 ease-in-out hover:text-white hover:bg-blue-400 disabled:opacity-50 disabled:pointer-events-none"
              onClick={handleEdit}
            ...
            <button
              className="p-2 text-gray-400 transition-colors duration-200 ease-in-out hover:text-white hover:bg-red-400 disabled:opacity-50 disabled:pointer-events-none"
